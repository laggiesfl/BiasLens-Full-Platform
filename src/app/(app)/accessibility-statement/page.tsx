    ...
    <div className="stack" style={{ maxWidth: "75ch" }}>
      ...
      <section className="card stack" aria-labelledby="prep-h">
        ...
        <p>
          ...
          reviewed on <strong>31 July 2026</strong>.
        </p>
        <p>
      ...
      <section className="card stack" aria-labelledby="feedback-h">
        ...
        <p>
          <strong>If you cannot use email,</strong> reach us through any channel
          that works for you and we will make arrangements that suit you.
        </p>
        <p>
