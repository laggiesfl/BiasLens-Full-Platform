  ...
  return (
    <FieldGroup>
      <p className={styles.sectionNote}>
        Your organisation and name are filled in from your Account Settings where you
        have set them. Changing them here applies only to this assessment.
      </p>
      <Field id="orgName" label="Organisation name" required>
        <input id="orgName" type="text" className={styles.input} autoComplete="organization" value={data.organisationName} onChange={e => update('organisationName', e.target.value)} aria-required="true" placeholder="e.g. Acme Financial Services Ltd" />
      </Field>
      <Field id="completedBy" label="Completed by" required hint="Include name and role, e.g. Jane Smith, Chief Compliance Officer">
        <input id="completedBy" type="text" className={styles.input} autoComplete="name" value={data.completedBy} onChange={e => update('completedBy', e.target.value)} aria-required="true" aria-describedby="completedBy-hint" placeholder="Name and role" />
      </Field>
  ...
  return (
    <FieldGroup>
      <Field id="safeguards" label="Existing safeguards">
        <textarea id="safeguards" className={styles.textarea} rows={4} value={data.existingSafeguards} onChange={e => update('existingSafeguards', e.target.value)} placeholder="Describe safeguards already in place, such as human oversight, audit trails, appeal mechanisms, accessibility accommodations" />
      </Field>
