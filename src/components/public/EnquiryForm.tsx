  ...
  return (
    <form onSubmit={submit} noValidate>
      {Object.keys(errors).length > 0 && (
        <div className="public-error-summary" role="alert" tabIndex={-1} ref={summaryRef}>
          <h2>There is a problem with your enquiry</h2>
          <ul>
      ...
      <div className="public-field">
        <div className="public-consent">
          ...
          <label htmlFor="consent">
            I consent to BeAccessible using the information in this form to respond to this BiasLens enquiry. <span aria-hidden="true">*</span>
          </label>
        </div>
      ...
      <div className="public-submit-row">
        <button type="submit" className="public-button public-button-primary" disabled={submitting}>
          {submitting ? "Submitting…" : "Submit BiasLens enquiry"}
        </button>
